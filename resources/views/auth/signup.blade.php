...
<head>
  ...
  <title>Sign Up &mdash; Sistem Manajemen Pondok Pesantren</title>
  <!-- Favicon -->
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    <div class="d-block">
                    	<label for="password" class="control-label">Retype Your Password</label>
                    </div>
                    <div class="input-group" id="show_hide_password">
                      <input id="password" type="" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="retype your password" required autocomplete="current-password">
                      <div class="input-group-append">
                        <div class="input-group-text">
                            <a href="javascript:void(0)"><i class="fa fa-eye-slash" aria-hidden="true"></i></a>
                        </div>
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4">
                      <div style="font-size: 15px">Sign Up</div>
                    </button>
                  </div>
                </form>
